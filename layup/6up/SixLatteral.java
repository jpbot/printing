//source recovered from .class using jd
//7-nov-2014 jpm
...
public class SixLatteral
{
  public static void main(String[] paramArrayOfString)
  {
    ...
    if (str2.toLowerCase().endsWith(".pdf")) {
      str2 = str2.replaceAll(".pdf\\z", "-6U.pdf");
    } else {
      str2 = str2.concat("-6U");
    }
    try
    {
      ...
      Document localDocument = new Document(new Rectangle(f2 * 2.0F, f3 * 3.0F));
      
      System.out.println("Destination Page size: " + f2 * 2.0F + "x" + f3 * 2.0F);
      ...
      for (int k = 1; k <= j; k++)
      {
        ...
        for (int m = 0; m < 6; m++)
        {
          ...
          if (n <= i)
          {
            ...
            localPdfContentByte.setFontAndSize(localBaseFont, 8.0F);
            String str3 = String.valueOf(n);
            

            localPdfContentByte.setTextMatrix(f4 + 24.0F, f5 + 16.0F);
